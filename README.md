# @hishprorg/sed-quod-necessitatibus  [![npm version](https://badge.fury.io/js/%40daybrush%2Futils.svg)](https://badge.fury.io/js/%40daybrush%2Futils)
...
```
$ npm i @hishprorg/sed-quod-necessitatibus
```

```js
import {TRANSFORM, requestAnimationFrame, splitComma} from "@hishprorg/sed-quod-necessitatibus";
```
